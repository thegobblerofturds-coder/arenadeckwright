...
STATUS
The Ultimate Version is the full-featured development edition published separately at /ultimate/. Version 6 remains the standard /colour/ release. Internally this edition continues in the version7 source folder so its history, storage migration, and tests remain stable.

QUICK START
1. Keep every Ultimate Version file in one folder.
...
RELEASE CHECKLIST
1. Confirm the header says ULTIMATE and the footer links the Ultimate offline ZIP.
...
FILES
- index.html: Ultimate Version interface and semantic controls.
...
- styles.css: Version 6 visual system plus integrated Ultimate FX and Lab panels.
